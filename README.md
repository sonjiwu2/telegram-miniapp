...
| `AI_PROVIDER` / `AI_API_KEY` / `AI_MODEL` | нет | Провайдер, ключ и модель для AI-вердиктов. Без них фича выключена (`503 AI_NOT_CONFIGURED`), остальное приложение AI не требует |
